...
document.addEventListener("click", (e) => {
    ...
    if (targetElement.closest(".search-top__btn"))
        targetElement.closest(".search-top").classList.toggle("search-active");
    if (!targetElement.closest(".search-top__btn") && !targetElement.closest(".search-top__body"))
        removeClasses(document.querySelectorAll(".search-top.search-active"), "search-active");
});
